<?php /* Smarty version Smarty-3.1.8, created on 2013-07-19 14:31:50
         compiled from "./admin/views/default\index\menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:978751e4a8f81ba511-28758900%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '978751e4a8f81ba511-28758900',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_51e4a8f82f78a9_16797406',
  'variables' => 
  array (
    'url' => 0,
    'res' => 0,
...
<?php if ($_valid && !is_callable('content_51e4a8f82f78a9_16797406')) {function content_51e4a8f82f78a9_16797406($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("public/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
/article" target="main">管理文章</a></li>
						...
						<ul id="list25">
						    <li><a class="list"  href="<?php echo $_smarty_tpl->tpl_vars['app']->value;?>
/play/add" target="main">添加幻灯</a></li>
							<li><a class="list" href="<?php echo $_smarty_tpl->tpl_vars['app']->value;?>
/play" target="main">管理幻灯</a></li>
						...
						<?php }else{ ?>
							<h4>没有文章管理权限</h4>
						<?php }?>
                                                <h4 onclick="domenu(this, 'list26')" class="tit">--项目管理--</h4>
                                                <ul id="list26">
                                                          <li><a class="list"  href="<?php echo $_smarty_tpl->tpl_vars['app']->value;?>
/projects/add" target="main">添加项目</a></li>
							<li><a class="list"  href="<?php echo $_smarty_tpl->tpl_vars['app']->value;?>
/projects" target="main">管理项目</a></li>
